...
public abstract class CatalyzedMachineRecipe extends BaseMachineRecipe {
    ...
    protected CatalyzedMachineRecipe(int catalystSlot, int energy, float experience, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {
    ...
    public CatalyzedMachineRecipe(int energy, float experience, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {

        this(1, energy, experience, maxPower, inputItems, inputFluids, outputItems, chance, outputFluids);
    }

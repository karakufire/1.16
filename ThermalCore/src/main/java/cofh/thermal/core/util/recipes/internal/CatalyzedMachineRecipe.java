...
public abstract class CatalyzedMachineRecipe extends BaseMachineRecipe {
    ...
    protected CatalyzedMachineRecipe(int catalystSlot, int energy, float experience, int minPower, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {

        super(energy, experience, minPower, maxPower, inputItems, inputFluids, outputItems, chance, outputFluids);
    ...
    public CatalyzedMachineRecipe(int energy, float experience, int minPower, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {

        this(1, energy, experience, minPower, maxPower, inputItems, inputFluids, outputItems, chance, outputFluids);
    }

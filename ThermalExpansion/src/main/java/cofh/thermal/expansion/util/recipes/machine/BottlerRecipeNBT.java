...
public class BottlerRecipeNBT extends BaseMachineRecipe {
    ...
    public BottlerRecipeNBT(int energy, float experience, int maxPower, @Nonnull ItemStack inputItem, @Nonnull FluidStack inputFluid, @Nonnull ItemStack outputItem) {

        super(energy, experience, maxPower);

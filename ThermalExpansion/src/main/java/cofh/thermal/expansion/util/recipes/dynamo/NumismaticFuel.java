...
public class NumismaticFuel extends ThermalFuel {
    ...
    public NumismaticFuel(ResourceLocation recipeId, int energy, int minPower, int maxPower, @Nullable List<Ingredient> inputItems, @Nullable List<FluidStack> inputFluids) {

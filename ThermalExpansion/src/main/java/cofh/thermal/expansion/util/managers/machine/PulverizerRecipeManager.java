...
public class PulverizerRecipeManager extends SingleItemRecipeManager.Catalyzed {
    ...
    protected IMachineRecipe addRecipe(int energy, float experience, int minPower, int maxPower, List<ItemStack> inputItems, List<FluidStack> inputFluids, List<ItemStack> outputItems, List<Float> chance, List<FluidStack> outputFluids) {
        ...
        InternalPulverizerRecipe recipe = new InternalPulverizerRecipe(energy, experience, minPower, maxPower, inputItems, inputFluids, outputItems, chance, outputFluids);
    ...
    protected static class InternalPulverizerRecipe extends CatalyzedMachineRecipe {
        ...
        public InternalPulverizerRecipe(int energy, float experience, int minPower, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {

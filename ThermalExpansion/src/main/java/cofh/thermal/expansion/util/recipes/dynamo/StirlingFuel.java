...
public class StirlingFuel extends ThermalFuel {
    ...
    public StirlingFuel(ResourceLocation recipeId, int energy, int minPower, int maxPower, @Nullable List<Ingredient> inputItems, @Nullable List<FluidStack> inputFluids) {

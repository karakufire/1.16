...
public class FurnaceRecipe extends ThermalRecipe {
    ...
    public FurnaceRecipe(ResourceLocation recipeId, int energy, float experience, int minPower, int maxPower, @Nullable List<Ingredient> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> outputItemChances, @Nullable List<FluidStack> outputFluids) {
    ...
    public FurnaceRecipe(ResourceLocation recipeId, int energy, float experience, AbstractCookingRecipe recipe) {
        ...
        this(recipeId, energy, experience, -1, -1, recipe.getIngredients(), Collections.emptyList(), Collections.singletonList(recipe.getRecipeOutput()), Collections.singletonList(BASE_CHANCE_LOCKED), Collections.emptyList());
    }

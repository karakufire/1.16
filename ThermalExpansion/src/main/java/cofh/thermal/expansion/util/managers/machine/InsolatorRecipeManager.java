...
public class InsolatorRecipeManager extends SingleItemRecipeManager.Catalyzed {
    ...
    protected IMachineRecipe addRecipe(int energy, float experience, int minPower, int maxPower, List<ItemStack> inputItems, List<FluidStack> inputFluids, List<ItemStack> outputItems, List<Float> chance, List<FluidStack> outputFluids) {
        ...
        InternalInsolatorRecipe recipe = new InternalInsolatorRecipe(energy, experience, minPower, maxPower, inputItems, inputFluids, outputItems, chance, outputFluids);
    ...
    protected static class InternalInsolatorRecipe extends CatalyzedMachineRecipe {
        ...
        public InternalInsolatorRecipe(int energy, float experience, int minPower, int maxPower, @Nullable List<ItemStack> inputItems, @Nullable List<FluidStack> inputFluids, @Nullable List<ItemStack> outputItems, @Nullable List<Float> chance, @Nullable List<FluidStack> outputFluids) {
